...
function [] = plot_8cams_figures_final(truth,meas)
    D1 = load("results/scenario2_Fixed_results_10runs_2.mat");
    num_estimates_fixed = D1.num_estimates;
    D2 = load("results/scenario2_ISC_results_10runs_2.mat");
    num_estimates_single = D2.num_estimates;
    D3 = load("results/scenario2_DCD_1_results_10runs.mat");
    num_estimates_dcd_1 = D3.num_estimates;
    D4 = load("results/scenario2_DCD_2_results_10runs.mat");
    num_estimates_dcd_5 = D4.num_estimates;
    D5 = load("results/scenario2_DCD_3_results_10runs.mat");
    num_estimates_dcd_10 = D5.num_estimates;
    D6 = load("results/scenario2_DMSC_results_10runs_2.mat");
    ...
    legend(gca,'Truth','Fixed', 'I-SC', 'DCD-SC (1)', 'DCD-SC (2)', 'DCD-SC (3)', 'FDCD-SC', 'Location', 'southeast');
    set(gca, 'XLim',[1 meas{1}.K]); set(gca, 'YLim',[0 max(truth.N)+1]);
    xlabel('Time Steps'); ylabel('Cardinality');
    %title("Cardinality")
    
    saveas(gcf, "plot_8cams_cardinality_comparison_final.pdf")
end